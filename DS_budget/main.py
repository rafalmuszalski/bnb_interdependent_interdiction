...
def plot_colored_graph(G, protected_by, w_hat=[], x_hat=[], y_hat=[], name:str="test"):
    log_directory = os.getenv("EXPERIMENT_DIR", "DS_budget/logs/local")
...
def run_CCG(n:int, k:int, b_p:int, b_a:int, seed:int, time_limit:int=60*60*3):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--structure_propagation", type=int,   default=1, choices=[-1, 0, 1], help="Attacker constr. propagation type")
    parser.add_argument("--seed",                  type=int,   default=1)
    parser.add_argument("--time_limit",            type=float, default=60 * 60 * 3)
    parser.add_argument("--bnb_only", action="store_true")
